...
const galleryImages = [
    { src: "/assets/images/mcpchatbot.png", alt: "MCP Cursor Integration" },
];

const MCPChatbotCursor = () => {
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-6xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-[#e91e63] mb-6">MCP Chatbot Cursor Integration</h1>
                    <h2 className="text-2xl md:text-3xl text-white font-semibold mb-8">Integrated Development Assistant</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        Intelligent chatbot that integrates multiple MCP servers with Groq LLMs for seamless task orchestration in the Cursor IDE. This project brings AI assistance directly into the developer's workflow.
                    </p>

                    <p className="text-[#e91e63] font-bold mb-4 uppercase tracking-widest text-sm">GitHub Repository Links:</p>
                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <a
                            href="https://github.com/Subitha-Murugesan/MCP-Chatbot-Cursor-Integration"
                            target="_blank"
                        ...
                        >
                            <Github size={20} /> Cursor Integration
                        </a>
                        <a
                            href="https://github.com/Subitha-Murugesan/MCP-Multi-Server-Chatbot"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-3 rounded-full font-bold transition-all transform hover:scale-105 shadow-lg flex items-center gap-2"
                        >
                            <Github size={20} /> Multi-Server Chatbot
                        </a>
                        <a
                            href="https://github.com/Subitha-Murugesan/MCP-Weather-Chatbot"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-3 rounded-full font-bold transition-all transform hover:scale-105 shadow-lg flex items-center gap-2"
                        >
                            <Github size={20} /> Weather Chatbot
                        </a>
                    </div>
                </div>
            </header>
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                By leveraging the Model Context Protocol (MCP), this chatbot connects directly to the Cursor IDE environment. It allows developers to perform complex tasks, query documentation, and manipulate code using natural language, powered by the speed of Groq LLMs.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "MCP Client & Agent", desc: "Manages communication between the chatbot and MCP servers for coordinated task execution" },
                                    { title: "Multi-Server Integration", desc: "Integrates multiple MCP servers including Playwright MCP (browser automation), DuckDuckGo MCP (web search), and Airbnb MCP (travel search)" },
                                    { title: "LLM-Powered Intelligence", desc: "Powered by Groq models (qwen3-32b, llama3, etc.) for natural, context-aware responses and intelligent decision-making" },
                                    { title: "Cursor IDE Integration", desc: "Configure MCP in Cursor settings to enable seamless agent-server communication inside the development environment" },
                                ].map((feature, idx) => (
...
export default MCPChatbotCursor;
