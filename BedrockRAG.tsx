...
const galleryImages = [
    { src: "/assets/images/awsrag.png", alt: "Bedrock RAG Architecture" },
];
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-6xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-[#e91e63] mb-6">Chat with PDF using AWS Bedrock RAG</h1>
                    <h2 className="text-2xl md:text-3xl text-white font-semibold mb-8">Cloud-Native Document Chat</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        Cloud-native RAG application that allows users to interactively query PDF documents and receive context-aware answers using LangChain and AWS Bedrock.
                    </p>

                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <a
                            href="https://github.com/Subitha-Murugesan/Chat-with-PDF-using-AWS-Bedrock-RAG"
                            target="_blank"
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                This project delivers a production-grade RAG pipeline entirely on AWS. It uses Amazon Bedrock for accessing powerful foundation models like Claude and Titan, and LangChain for orchestration, enabling secure and scalable document search and summarization within the AWS ecosystem.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "PDF Processing & Embedding", desc: "Extracts text content from PDFs and converts it into embeddings using Amazon Titan Embeddings" },
                                    { title: "Semantic Search", desc: "Retrieves the most relevant sections from the PDF based on user queries for improved accuracy" },
                                    { title: "Generative Response", desc: "Uses Claude/Mistral models via Amazon Bedrock to generate human-like answers grounded in the retrieved PDF content" },
                                    { title: "Interactive Frontend", desc: "Provides a simple, interactive Streamlit chat interface where users can upload PDFs and ask questions" },
                                ].map((feature, idx) => (
