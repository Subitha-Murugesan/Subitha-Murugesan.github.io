...
const galleryImages = [
    { src: "/assets/images/agenticai.webp", alt: "Agentic AI Overview" },
];
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-6xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-[#e91e63] mb-6">Agentic AI with Phidata Framework Multimodal Agents</h1>
                    <h2 className="text-2xl md:text-3xl text-white font-semibold mb-8">Multimodal Financial & News Agents</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        Multimodal agentic AI application that combines specialized agents for stock analysis and news retrieval using Phidata and Groq LLM. This project showcases the collaborative power of specialized AI agents.
                    </p>

                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <a
                            href="https://github.com/Subitha-Murugesan/Agentic-AI-with-Phidata-Multimodal-Agents"
                            target="_blank"
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                Using the Phidata framework, this project builds a team of specialized AI agents. One agent focuses on analyzing stock market data, while another retrieves relevant financial news. Working together, they provide comprehensive financial insights, powered by the speed and efficiency of Groq LLMs.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "User Query Handling", desc: "The system receives a natural language query from the user and processes it through the agentic pipeline" },
                                    { title: "Specialized Agents", desc: "Multiple autonomous agents are triggered: Finance Agent (YFinanceTools) and News Agent (GoogleSearch/DuckDuckGo)" },
                                    { title: "LLM Integration & Reasoning", desc: "Groq-powered LLM (Meta LLaMA 4 Scout) combines outputs from the agents and generates a human-readable, summarized response" },
                                    { title: "Multimodal Pipeline", desc: "Enables users to query complex topics such as stock recommendations and latest news, receiving integrated, context-aware answers" },
                                ].map((feature, idx) => (
