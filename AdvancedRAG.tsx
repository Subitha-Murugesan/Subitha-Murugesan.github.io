...
const galleryImages = [
    { src: "/assets/images/RAG_Aktiengesellschaft.svg", alt: "Advanced RAG Pipeline Architecture" },
];
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-6xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-[#e91e63] mb-6">Advanced RAG Pipeline</h1>
                    <h2 className="text-2xl md:text-3xl text-white font-semibold mb-8">LangChain & Ollama Powered Retrieval</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        RAG pipeline that retrieves relevant documents and generates accurate answers using LangChain, Ollama, Chroma, and FAISS. This project showcases advanced techniques in retrieval-augmented generation for building robust Q&A systems.
                    </p>

                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <a
                            href="https://github.com/Subitha-Murugesan/RAG-Retrieval-Augmented-Generation"
                            target="_blank"
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                This project implements a sophisticated Retrieval-Augmented Generation (RAG) pipeline. By combining LangChain for orchestration, Ollama for local LLM inference, and Chroma/FAISS for vector storage, it enables accurate and context-aware document question answering.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "Document Retrieval", desc: "Retrieves contextually relevant documents based on user queries using Ollama (Meta LLaMA models)." },
                                    { title: "Text Processing & Embedding", desc: "Loads and processes unstructured text documents for embedding." },
                                    { title: "Vector Storage", desc: "Generates vector embeddings and stores them using Chroma and FAISS vector stores." },
                                    { title: "RAG Pipeline Flow", desc: "Demonstrates core RAG flow: Document Ingestion → Embedding → Vector Storage → Retrieval → Response Generation." },
                                ].map((feature, idx) => (
                        ...
                        <section>
                            ...
                            <ul className="text-gray-300 space-y-3 list-disc list-inside bg-white/5 p-6 rounded-lg border border-white/5">
                                <li className="font-medium">Built with <span className="text-white">LangChain, Ollama, Chroma, FAISS, Python</span></li>
                                <li>Retrieval-Augmented Generation (RAG)</li>
                                <li>Vector Embeddings and Data Storage</li>
                                <li>Local LLMs</li>
                            </ul>
                        </section>
                    </div>
