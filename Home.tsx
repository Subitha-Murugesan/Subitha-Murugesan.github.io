    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {[
          ...
          { title: "Digital Parking Reservation System", img: "/assets/images/park1.png", description: "A web application for reserving parking spaces (frontend). Built with Vite + React (TypeScript) and a lightweight component/ui system.", link: "/projects/parking-reservation" }
        ].map((proj, idx) => (
        ...
        {[
          {
            ...
            img: "/assets/images/20260120_201944360_iOS.jpg",
