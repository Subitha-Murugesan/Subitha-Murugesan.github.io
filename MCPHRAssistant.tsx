...
const galleryImages = [
    { src: "/assets/images/MCP.svg", alt: "MCP Architecture" },
];

const MCPHRAssistant = () => {
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-6xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-[#e91e63] mb-6">MCP (Model Context Protocol)HR Leave Management Assistant</h1>
                    <h2 className="text-2xl md:text-3xl text-white font-semibold mb-8">Intelligent HR Automation</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        Python-based MCP server that powers an HR assistant chatbot for managing employee leave with natural language queries. This project demonstrates the potential of Model Context Protocol for creating context-aware AI assistants.
                    </p>

                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <a
                            href="https://github.com/Subitha-Murugesan/MCP-Server-for-HR-Leave-Management-Assistant"
                            target="_blank"
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                This project utilizes the Model Context Protocol (MCP) to build a sophisticated HR assistant. The chatbot understands natural language requests related to leave management and interacts with backend systems to process requests, demonstrating how AI can streamline administrative tasks.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "Natural Language Processing", desc: "Allows employees to request leave using everyday language." },
                                    { title: "MCP Server Development", desc: "Developed a Python-based MCP server using the MCP SDK to power an HR assistant chatbot for managing employee leave (checking balance, applying, viewing history)." },
                                    { title: "Tool Implementation", desc: "Designed and implemented key tools like get_leave_balance, apply_leave, and get_leave_history with detailed docstrings for LLM-driven tool selection." },
                                    { title: "Client Integration", desc: "Integrated the server with Claude Desktop as the client, enabling natural language queries and seamless multi-turn conversations." },
                                    { title: "Backend Management", desc: "Managed backend logic, mock database, and ensured smooth deployment with uv project manager and MCP installation." },
                                ].map((feature, idx) => (
                        ...
                        <section>
                            ...
                            <ul className="text-gray-300 space-y-3 list-disc list-inside bg-white/5 p-6 rounded-lg border border-white/5">
                                <li className="font-medium">Built with <span className="text-white">Python, FastAPI, MCP SDK</span></li>
                                <li>Model Context Protocol (MCP)</li>
                                <li>Chatbot Development</li>
                                <li>API Integration</li>
                                <li>Natural Language Processing</li>
                                <li>LLM Tool Design</li>
                                <li>API/Backend Development</li>
                                <li>Multi-turn Conversations</li>
                                <li>Client Integration(Claude Desktop)</li>
