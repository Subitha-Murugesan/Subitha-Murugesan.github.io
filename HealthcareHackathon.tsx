...
const galleryImages = [
    { src: "/assets/images/Hack4.png", alt: "Healthcare Hackathon Bayern 2025 Prototype" },
];

const HealthcareHackathon = () => {
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Healthcare Hackathon Bayern 2025</h1>
                    <h2 className="text-2xl md:text-3xl text-[#e91e63] font-semibold mb-4">AWS Bedrock + RAG Medical Prototype</h2>
                    <p className="text-gray-400 font-medium mb-8">
                        Conducted by AWS, Siemens Healthineers and Medical Valley
                    </p>
                    <p className="text-xl text-gray-400 max-Fw-3xl mx-auto mb-12">
                        Participated in the Healthcare Hackathon Bayern 2025, a 3-day innovation sprint focused on building digital solutions for modern healthcare challenges. Developed a conversational AI prototype using AWS Bedrock and RAG architecture to make complex healthcare data more accessible to patients and providers.
                    </p>
                </div>
            </header>
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                Healthcare Hackathon Bayern is an intensive 5-day event that brings together clinicians, developers, and designers to prototype solutions for the Bavarian healthcare system. The goal was to reduce the burden on administrative staff by automating patient queries while maintaining clinical accuracy.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg mb-6">
                                A cloud-native conversational assistant was constructed leveraging the scalability of AWS:
                            </p>
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "AWS Bedrock", desc: "Powered by Titan and Claude models for robust NLP capabilities." },
                                    { title: "Vector Databases", desc: "Efficient storage and retrieval of unstructured medical knowledge." },
                                    { title: "Patient-Facing UI", desc: "A simplified interface for patients to ask about clinic procedures and pre-op instructions." },
                                    { title: "Medical Grounding", desc: "Strict RAG protocols to ensure No 'AI hallucinations' in medical context." },
                                ].map((feature, idx) => (
                        ...
                        <section>
                            <h3 className="text-2xl font-bold text-white mb-4">The Innovation Sprint</h3>
                            <div className="bg-[#e91e63]/5 border border-[#e91e63]/20 p-6 rounded-lg">
                                <p className="text-gray-300 italic">
                                    "Over the course Three days, a conceptual idea was transformed into a working prototype, demonstrating that AWS-native RAG architectures can significantly decrease the response time for routine healthcare inquiries."
                                </p>
                            </div>
                        </section>
                    </div>
...
export default HealthcareHackathon;
