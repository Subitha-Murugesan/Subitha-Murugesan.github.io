...
const galleryImages = [
    { src: "/assets/images/AIAgents.png", alt: "LangChain Agent Architecture" },
];
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-6xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-[#e91e63] mb-6">LangChain Agent Combining Wikipedia, ArXiv, and Custom RAG Tools</h1>
                    <h2 className="text-2xl md:text-3xl text-white font-semibold mb-8">Dynamic Tool Selection Agent</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        LangChain agents that dynamically choose and use multiple tools (Wikipedia, ArXiv, custom RAG) to answer varied queries. This project highlights the ability of agents to reason and select the best source of information.
                    </p>

                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <a
                            href="https://github.com/Subitha-Murugesan/LangChain-Agents-with-Tools"
                            target="_blank"
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                This project demonstrates the implementation of a LangChain agent capable of using multiple tools. The agent can search Wikipedia for general knowledge, query ArXiv for academic papers, and use a custom RAG tool for specific document retrieval, dynamically deciding which tool to use based on the user's prompt.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "Multi-Tool Agent Development", desc: "Developed LangChain agents that dynamically choose and use multiple tools (Wikipedia, ArXiv, custom RAG retriever) to answer varied queries" },
                                    { title: "LLM Integration", desc: "Integrated with diverse LLMs, including OpenAI GPT-3.5-turbo and local Ollama Mistral models for flexible deployment" },
                                    { title: "Intelligent Tool Selection", desc: "Enabled agentic behavior where the agent intelligently selects the best tool based on the user's question" },
                                    { title: "Workflow Demonstration", desc: "Demonstrated the full workflow via a Jupyter Notebook showing tool setup, agent creation, and query handling" },
                                ].map((feature, idx) => (
