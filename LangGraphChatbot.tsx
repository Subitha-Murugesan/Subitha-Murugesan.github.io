...
const galleryImages = [
    { src: "/assets/images/langgraph.jpeg", alt: "LangGraph Agent Workflow" },
];
        ...
        <div className="min-h-screen bg-[#1a1325] text-white">
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-5xl mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-[#e91e63] mb-6">LangGraph Chatbot with External Tools (Wikipedia & Arxiv)</h1>
                    <h2 className="text-2xl md:text-3xl text-white font-semibold mb-8">Stateful AI Agent</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        Stateful chatbot using LangGraph that integrates Wikipedia and Arxiv APIs for extended knowledge retrieval. This project showcases the ability to maintain conversational state while accessing external information.
                    </p>

                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <a
                            href="https://github.com/Subitha-Murugesan/LangGraph-Chatbot-with-External-Tools-Wikipedia-Arxiv"
                            target="_blank"
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                This project utilizes LangGraph to build a stateful chatbot. Unlike stateless systems, this bot can remember conversation context and flow. It is augmented with external tools like Wikipedia and ArXiv, allowing it to provide up-to-date and scholarly information.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "Stateful Chatbot Development", desc: "Built a stateful chatbot using LangGraph with the Groq Gemma2-9b-It LLM" },
                                    { title: "External Knowledge Integration", desc: "Integrated external knowledge sources like Wikipedia and Arxiv APIs to answer questions beyond the bot's own knowledge" },
                                    { title: "Conditional Routing", desc: "Implemented conditional routing where the chatbot first tries to answer itself, then falls back to external tools as needed" },
                                    { title: "Extensible Design", desc: "Designed for easy extension to add more external tools in the future" },
                                ].map((feature, idx) => (
