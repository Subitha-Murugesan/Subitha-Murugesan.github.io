...
const galleryImages = [
    { src: "/assets/images/Hack2.jpg", alt: "EELISA GenAI Experience Lab Prototype" },
    { src: "/assets/images/EELISA_pp.jpg", alt: "EELISA GenAI Presentation" },
    { src: "/assets/images/EELISA_pp1.jpg", alt: "EELISA GenAI Award Ceremony" },
];
            ...
            <header className="pt-32 pb-16 px-8 bg-gradient-to-b from-[#1a1325] to-[#2a223a]">
                <div className="max-w-6xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 bg-[#e91e63]/20 text-[#e91e63] px-4 py-2 rounded-full mb-6 font-bold">
                        <Trophy size={20} /> 2nd Place Award
                    </div>
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">EELISA Generative AI Experience Lab</h1>
                    <h2 className="text-2xl md:text-3xl text-[#e91e63] font-semibold mb-4">GenAI Campus Hub Prototype</h2>
                    <p className="text-gray-400 font-medium mb-8">
                        Conducted by Friedrich-Alexander-Universität Erlangen-Nürnberg, EELISA European University, and Zürich University of Applied Sciences
                    </p>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
                        Participated in the EELISA Generative AI Experience Lab, developing a smart Campus Hub prototype that integrates specialized chatbots to enhance university services. Awarded 2nd place for technical innovation and user-centric design.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        ...
                        <a
                            href="https://www.linkedin.com/feed/update/urn:li:activity:7405883001278029824/"
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                The EELISA GenAI Lab brought together students and researchers across Europe to explore the potential of Generative AI in academic and campus environments. The goal was to build functional prototypes that solve tangible problems for the university community.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg mb-6">
                                Developed an integrated Campus Hub platform featuring a suite of specialized AI assistants. The Solution focused on making campus resources more accessible through natural conversation:
                            </p>
                            <ul className="grid md:grid-cols-2 gap-4">
                                {[
                                    { title: "Smart Library Agent", desc: "Assists with book search, availability checks, and reservation guidance." },
                                    { title: "Campus Navigation Bot", desc: "Helps students find lecture halls, offices, and cafeteria locations." },
                                    { title: "Course Helper", desc: "Provides information on timetables, credits, and course requirements." },
                                    { title: "Unified Interface", desc: "A seamless dashboard combining all services in a user-friendly mobile app." },
                                ].map((feature, idx) => (
                        ...
                        <section>
                            <h3 className="text-2xl font-bold text-white mb-4">Technical Recognition</h3>
                            <div className="bg-[#e91e63]/5 border border-[#e91e63]/20 p-6 rounded-lg">
                                <p className="text-gray-300 italic">
                                    "Prototype was recognized by the jury for its technical sophistication and its ability to provide immediate value to students, earning us the 2nd Place award in the competition."
                                </p>
                            </div>
                        </section>
                    </div>
